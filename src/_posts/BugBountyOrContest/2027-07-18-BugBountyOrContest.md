...
چرخه یا سایکل بلوغ امنیتی یک پروتکل عدمتا به شکل زیر هستش:
- توسعه
...
بعد از Judge شدن یک کانتست و نهایی شدن باگ ها، پرسنل مالی پلتفرم ها محاسبه پرداخت رو انجام میدن، از پروتکل یا کارفرما یا Sponsor میخوان که Vault رو جهت پرداخت پر کنه و در نهایت پراخت ها انجام میشه، پول میاد توی والتتون و در آخر Leaderboard اون کانتست منتشر میشه.

حالا که متوجه شدیم کانتست یعنی چی در ادامه به بررسی مزایا و معایبش میپردازیم.

### مزایا و معایب
#### مزایا
- پرداختی تضمین شده، شما به ازای باگی که ریپورت میکنید حتما پول دریافت خواهید کرد
- ارتقاء رزومه، عملکرد مناسب در کانتست ها به شما اعتبار میده و این اعتبار به شما در Private Audit خیلی کمک خواهد کرد
...
پس اگر قصدتون انجام باگ بانتی هستش سعی کنید Mindsetستون مثل وقتی که آدیت میکنید نباشه، اصطلاحا میگن باید مثل Black Hat ها فکر کنید.

### مزایا و معایب
### مزایا
- پرداختی های بسیار بالا
- عدم وجود محدودیت زمانی مثل کانتست ها که دارای یک Deadline هستن
